                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center">
                                        <div className="flex gap-1 items-center px-2">
                                            ...
                                            <p className="text-xs font-normal text-gray-500">{job.company}</p>
                            ...
                            <header className="border-b pb-4">
                                <div className="flex justify-between items-center">
                                    <div className="flex gap-2 items-center">
                                        <img
                                            src={selectedJob.image || "https://via.placeholder.com/50"}
                                ...
                                <p className="text-lg text-gray-600 mt-1">
                                    <span className="font-semibold">{selectedJob.company}</span> · {selectedJob.location}
                                </p>
                                <div className="flex gap-2 items-center mt-2">
                                    ...
                                    <p className="text-sm text-gray-500">Last updated: {selectedJob.updated}</p>
                                </div>
                            </header>
