    ...
    <div className="min-h-screen bg-gray-100/70">
      ...
      <div className="container mx-auto md:px-3 px-0 md:py-2 py-1">
        ...
        <div className="flex flex-col md:flex-row gap-1 mx-auto max-w-full">
          ...
          <div
            className={`w-full h-screen md:w-1/4 bg-white p-2 rounded-lg shadow-lg border border-gray-200 ${filterVisible ? "block" : "hidden"
              } md:block`}
          >
            {/* Main Heading */}
          ...
          {/* Right Side  */}
          <div className="hidden h-screen lg:block w-1/5 bg-white p-6 rounded-lg shadow-lg border border-gray-200">
            <div>
              <div className="flex items-center gap-2 border-b pb-2 mb-4">
